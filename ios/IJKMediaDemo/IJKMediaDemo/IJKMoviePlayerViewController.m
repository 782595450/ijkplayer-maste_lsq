...
//    [[UIApplication sharedApplication] setStatusBarOrientation:UIInterfaceOrientationLandscapeLeft animated:NO];
    ...
    self.player.view.frame = CGRectMake(0, 0,kScreenWidth/2, kScreenHeight);
...
//    self.player1 = [[IJKFFMoviePlayerController alloc] initWithContentURL:[NSURL URLWithString:@"http://devimages.apple.com.edgekey.net/streaming/examples/bipbop_16x9/gear4/prog_index.m3u8"] withOptions:options];
//    self.player1.view.autoresizingMask = UIViewAutoresizingFlexibleWidth|UIViewAutoresizingFlexibleHeight;
//    self.player1.view.frame = CGRectMake(kScreenWidth/2+20,0,kScreenWidth/2-20, kScreenHeight);
//    self.player1.scalingMode = IJKMPMovieScalingModeAspectFit;
//    self.player1.shouldAutoplay = YES;
